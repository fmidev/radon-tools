...
BuildRequires:  himan-lib >= 24.1.5
BuildRequires:  himan-lib-devel >= 24.1.5
BuildRequires:  himan-plugins-devel >= 24.1.5
...
Requires:	himan-lib >= 24.1.5
Requires:	himan-plugins >= 24.1.5
Requires:	netcdf-cxx
Requires:	eccodes
Requires:	libs3 >= 4.1
